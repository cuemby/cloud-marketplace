#!/bin/bash
# Bash user-data script for deploying Percona Server for MySQL via Cuemby Cloud Marketplace.
...
export PARAM_PERCONA_USER="{{param-percona-user}}"
export PARAM_PERCONA_DATABASE="{{param-percona-database}}"
export PARAM_PERCONA_DATA_SIZE="{{param-percona-data-size}}"
