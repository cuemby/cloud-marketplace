#!/usr/bin/env bash
# pre-install.sh — Drupal pre-install hook.
...
[[ -n "${_DRUPAL_PRE_INSTALL_DONE:-}" ]] && return 0
...
ssl_full_setup "drupal" "PARAM_DRUPAL_HOSTNAME" "drupal" 80 "drupal-tls"

export _DRUPAL_PRE_INSTALL_DONE=1
