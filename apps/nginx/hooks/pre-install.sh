#!/usr/bin/env bash
# pre-install.sh — NGINX pre-install hook.
...
[[ -n "${_NGINX_PRE_INSTALL_DONE:-}" ]] && return 0
...
ssl_full_setup "nginx" "PARAM_NGINX_HOSTNAME" "nginx" 80 "nginx-tls"

export _NGINX_PRE_INSTALL_DONE=1
