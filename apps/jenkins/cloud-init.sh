...
export APP_VERSION="${APP_VERSION:-13.6.17}"

# Required parameters
export PARAM_JENKINS_USERNAME="${PARAM_JENKINS_USERNAME:-user}"
export PARAM_JENKINS_PASSWORD="${PARAM_JENKINS_PASSWORD:?PARAM_JENKINS_PASSWORD is required}"

# SSL parameters (optional — hostname auto-detected via sslip.io if not set)
export PARAM_JENKINS_HOSTNAME="${PARAM_JENKINS_HOSTNAME:-}"
