...
# Firewall: allow inbound TCP on port 30637 (Valkey).
...
export APP_VERSION="${APP_VERSION:-5.3.0}"

# Required parameters
export PARAM_VALKEY_PASSWORD="${PARAM_VALKEY_PASSWORD:?PARAM_VALKEY_PASSWORD is required}"
