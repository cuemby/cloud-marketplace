#!/usr/bin/env bash
# pre-install.sh — Redmine pre-install hook.
...
[[ -n "${_REDMINE_PRE_INSTALL_DONE:-}" ]] && return 0
...
ssl_full_setup "redmine" "PARAM_REDMINE_HOSTNAME" "redmine" 80 "redmine-tls"

export _REDMINE_PRE_INSTALL_DONE=1
