#!/usr/bin/env bash
# pre-install.sh — Parse pre-install hook.
...
[[ -n "${_PARSE_PRE_INSTALL_DONE:-}" ]] && return 0
...
ssl_full_setup "parse" "PARAM_PARSE_HOSTNAME" "parse-dashboard" 80 "parse-tls"

export _PARSE_PRE_INSTALL_DONE=1
